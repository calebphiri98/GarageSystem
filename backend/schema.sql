...
-- ---------------- Seed: default manager + admin (password = "password123") ----------------
-- Hash below is a real bcrypt hash for the string "password123" (verified with PHP password_verify).
-- CHANGE THIS PASSWORD AFTER FIRST LOGIN.
INSERT INTO users (name, email, password_hash, role) VALUES
('System Manager', 'manager@uptowngarage.com', '$2y$10$0ZevfcO1CUZjqjjh0bfqJON.fkd1R.cFNejL3yL27C5gf/mA.tgtS', 'manager'),
('Garage Administrator', 'admin@uptowngarage.com', '$2y$10$0ZevfcO1CUZjqjjh0bfqJON.fkd1R.cFNejL3yL27C5gf/mA.tgtS', 'admin');
